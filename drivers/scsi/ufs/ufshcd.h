...
int ufshcd_read_string_desc(struct ufs_hba *hba, u8 desc_index,
			    u8 **buf, bool ascii);
static int __maybe_unused ufshcd_wb_ctrl(struct ufs_hba *hba, bool enable);
static int __maybe_unused ufshcd_wb_toggle_flush_during_h8(struct ufs_hba *hba, bool set);
static inline void __maybe_unused ufshcd_wb_toggle_flush(struct ufs_hba *hba, bool enable);
#endif /* End of Header */
